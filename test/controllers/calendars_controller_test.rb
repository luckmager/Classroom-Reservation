...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post calendars_url, params: { calendar: { classroom: @calendar.classroom, endTime: @calendar.endTime, reservation: @calendar.reservation, startTime: @calendar.startTime } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { classroom: @calendar.classroom, endTime: @calendar.endTime, reservation: @calendar.reservation, startTime: @calendar.startTime } }
